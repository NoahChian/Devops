...
public class ViewDishAndIngredient implements java.io.Serializable {
	...
	/** default constructor */
	public ViewDishAndIngredient() {
	}

	/** minimal constructor */
	public ViewDishAndIngredient(ViewDishAndIngredientId id, String dishname,
	...
	/** full constructor */
	public ViewDishAndIngredient(ViewDishAndIngredientId id, String menudate, Integer schoolid,
			...
			String supplierName, String brandNo, String filepath) {
