 ...
 * Restaurant entities. Transaction control of the save(), update() and
 * delete() operations can directly support Spring container-managed
 * transactions or they can be augmented to handle user-managed Spring
 * transactions. Each of these methods provides additional information for how
 * to configure it for the desired type of transaction control.
 * 
 * @see org.iii.ideas.catering_service.dao.Restaurant
 * @author MyEclipse Persistence Tools
 */
@Transactional
public class RestaurantDAO {
	private static final Logger log = LoggerFactory.getLogger(RestaurantDAO.class);
	...
	public RestaurantDAO(Session dbSession) {
	...
	public Restaurant findById(Integer id) {
		...
		try {
			Restaurant instance = (Restaurant) getCurrentSession().get("org.iii.ideas.catering_service.dao.Restaurant", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Restaurant instance) {
		...
		try {
			List results = getCurrentSession().createCriteria("org.iii.ideas.catering_service.dao.Restaurant").add(Example.create(instance)).list();
	...
	public List findByProperty(String propertyName, Object value) {
		log.debug("finding Restaurant instance with property: " + propertyName + ", value: " + value);
		try {
			String queryString = "from Restaurant as model where model." + propertyName + "= ?";
	...
	public List findByRestaurantId(Integer restaurantId) {
		return findByProperty(RESTAURANT_ID, restaurantId);
	}
	...
	public Restaurant merge(Restaurant detachedInstance) {
		...
		try {
			Restaurant result = (Restaurant) getCurrentSession().merge(detachedInstance);
