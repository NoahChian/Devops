...
public class UpdateMail extends AbstractApiInterface<UpdateMailRequest, UpdateMailResponse>{
...
//		}
		...
		if(!this.requestObj.getUsertype().equals("009")){
			this.responseObj.setResStatus(0);
			this.responseObj.setMsg("請確認帳戶身分");
			return;
		}
