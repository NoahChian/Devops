...
<body>
	...
	<!-- 控制前一頁/後一頁的panel -->
	<div id='controller'>
		<div class="w_100ps h_44px tal_ch GOBK_BBT">
		<a href="#"  onclick="showCalendar()" >回前頁</a> 
		<a id="btn_before_day" href="#" onclick="query_detail_data()" style="display:none">前一日</a>
		<a id="btn_after_day" href="#" onclick="query_detail_data()" style="display:none">後一日</a>
	</div>
