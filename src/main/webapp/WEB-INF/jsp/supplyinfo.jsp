...
<script src="../../js_ca/supplyinfo.js"></script>
<%
	Integer countyId = 0;
	String countyType = "";
	String uType = "";
...
<body>
<!-- 四點設計套版 -->
	<div class="contents-title">食材供應商供貨資訊</div>
	...
	<div style="display:none">
		<div id="" class="GRE_ABR h_30px lh_30">
			<div  class="TITLE_TXT flo_l">食材供應商供貨資訊</div>
		</div>
		<div id="MAIN_SECOND_BAR" class="lh_35 GRA_ABR TAB_TY_B">
			<table width="100%">
				<tbody>
					<tr>
						<td bgcolor="ffffff" class="" align="center">品牌名稱</td>
						<td bgcolor="ffffff" class=""><input type="text" id="brand"
							class="searchInput max255" /></td>
						<td bgcolor="ffffff" class="" align="center">供應商名稱</td>
						<td bgcolor="ffffff" class=""><input type="text"
							id="supplierName" class="searchInput max255" /></td>
					</tr>
					<tr>
