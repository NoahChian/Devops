		    ...
		    <div class="row">
		    	<div id="SUB_NAV">
		    		<div class="col-xs-12 sidebar-nav">
			    		...
			    		<div style="display:<%=demoDisplay%>">
			    			<tiles:insertAttribute name="navifooter_demo"/>
			    		</div>
			    		<tiles:insertAttribute name="navifooter"/>
		    		</div>
		        </div>
...
<div id="FOOTERx">
	<span class="FOOTER_JO_FG">
		...
		或<a href="http://moztw.org/firefox/" target="_blank">Firefox</a>｜<a href="../privacy/" target="_blank">隱私權宣告</a><br>
