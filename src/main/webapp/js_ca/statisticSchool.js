...
function export_excel(){
	...
	var link = "/cateringservice/rest/API/XLS/statisticSchool&" + countyId + "&" + kitchenId+ "&" + restaurantId + "&" + schoolId + "&" + queryType;	
