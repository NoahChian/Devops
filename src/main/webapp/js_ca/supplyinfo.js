...
function query_Ingredient_List(page)
{
	...
	var countyId =-1;
	if(brand == ""  && supplierName == ""){
		$(".blockUIImgs").hide();
		$(".blockUIMsgs").html("供應商、品牌不可皆空白。");
...
//清單內容
	...
	for(var i in result_content.ingredient2) {
		...
		//if(result_content.ingredient2[i].stockDate!=null){stockDate=result_content.ingredient2[i].stockDate;}
		//if(result_content.ingredient2[i].manufactureDate!=null){manufactureDate=result_content.ingredient2[i].manufactureDate;}
		//if(result_content.ingredient2[i].expirationDate!=null){expirationDate=result_content.ingredient2[i].expirationDate;}
