...
function export_excel(){
	...
	var link = "/cateringservice/rest/API/XLS/statisticSupplier&" + countyId + "&" + kitchenId+ "&" + restaurantId + "&" + schoolId + "&" + queryType;	
